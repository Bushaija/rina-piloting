...
export function EnhancedExecutionFormUpdated({ 
  ...
  const draftMeta = useMemo(() => {
    ...
    return {
      ...
      quarter: quarter, // Add quarter to metadata for proper scoping
    };
  }, [searchParams, facilityType, projectType, quarter, effectiveMode]);

  const draftId = useMemo(() => {
    const raw = `${draftMeta.programName}_${draftMeta.facilityType}_${draftMeta.facilityId}_${draftMeta.facilityName}_${draftMeta.reportingPeriod}_${draftMeta.quarter}_${draftMeta.mode}`;
